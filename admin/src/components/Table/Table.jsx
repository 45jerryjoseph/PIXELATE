...
import { grey, indigo ,deepPurple } from '@mui/material/colors';
...
export default function EnhancedTable({open,setOpen,openDelete,setOpenDelete}) {
  ...
  return (
    <>
    <Box sx={{ width: '100%' , bgcolor: indigo[100],borderRadius: '30px'}}>
      <Paper sx={{ width: '100%', mb: 2,bgcolor: indigo[100] }}>
        <EnhancedTableToolbar numSelected={selected.length} />
        <TableContainer sx={{bgcolor: grey[400]}}>
          <Table
            sx={{ minWidth: 750 }}
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">
                        ...
                        <Button onClick={handleOpenDelete}><DeleteIcon style={{"color":"red"}}/></Button>
